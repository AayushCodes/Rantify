...
alle = "All my friends are toxic or ambitionless so rude and always negative, Ineed new friends but it's not that quick and easy oh i'm drowning letme breathe."
...
for i in friday:
    ...
    if heppy > sed:
        print('heppy by - ', round(heppy/sed, 2))
    else:
        print('sed by -', round(sed/heppy, 2))
